...
DROP POLICY IF EXISTS "Users view own consultations" ON public.ai_consultations;
DROP POLICY IF EXISTS "Admins view all consultations" ON public.ai_consultations;
DROP POLICY IF EXISTS "Anyone can submit consultations" ON public.ai_consultations;
DROP POLICY IF EXISTS "Admins can update consultations" ON public.ai_consultations;
...
DROP POLICY IF EXISTS "Users access own webhook secrets" ON public.webhook_secrets;
