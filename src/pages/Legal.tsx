...
import { FileText, Shield, Scale, Cookie, FileCheck, Clock, FileSignature } from "lucide-react";
...
const Legal = () => {
  const quickLinks = [
    ...
    { id: "hav-ta", label: "Tilläggsavtal AI-system", icon: FileSignature },
  ];
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-hero min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12 relative">
        ...
        <section id="hav-ta" className="mb-12 bg-white/5 p-8 rounded-xl backdrop-blur-sm border border-white/10 hover:shadow-elegant transition-all duration-300">
          <div className="flex items-center gap-3 mb-6 border-b border-accent/20 pb-4">
            <div className="p-2 bg-accent/10 rounded-lg">
              <FileSignature className="w-6 h-6 text-accent" />
            </div>
            <h1 className="text-3xl font-display font-bold text-white">Hiems Handelsbolag – Tilläggsavtal för köp av AI-system (HAV-TA 1.0)</h1>
          </div>
          <p className="text-white/70 mb-6"><strong>Bilaga till Hiems Allmänt Avtal (HAV 1.0)</strong></p>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">1. Parter</h2>
            <p className="text-white/70 mb-3">Detta Tilläggsavtal ("Tilläggsavtalet") har ingåtts mellan:</p>
            <div className="space-y-4">
              <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                <p className="text-white font-semibold mb-2">Leverantör:</p>
                <ul className="space-y-1 text-white/70">
                  <li>Hiems Handelsbolag</li>
                  <li>Org.nr: 969802-0246</li>
                  <li>VAT: SE969802024601</li>
                  <li>Registrerad adress: Stockholm, Sverige</li>
                  <li>Kontakt: <a href="mailto:support@hiems.se" className="text-accent hover:underline">support@hiems.se</a></li>
                </ul>
              </div>
              <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                <p className="text-white font-semibold mb-2">Kund:</p>
                <ul className="space-y-1 text-white/70">
                  <li>Företagsnamn / Kontaktperson: ________________________________</li>
                  <li>Organisationsnummer: ________________________________________</li>
                  <li>Adress: ______________________________________________________</li>
                  <li>E-postadress: _______________________________________________</li>
                </ul>
              </div>
            </div>
          </article>
          ...
          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">2. Syfte</h2>
            <p className="text-white/70 mb-3">Detta Tilläggsavtal reglerar villkor för köp av Hiems AI-system och konsulttjänster, inklusive leverans, betalning, kundspecifika anpassningar, driftansvar och eventuellt tillägg för support.</p>
            <p className="text-white/70 mb-3">Avtalet kompletterar HAV 1.0, SLA, DPA, AUP, Integritetspolicy och Användarvillkor, vilka alltid gäller parallellt och har företräde vid konflikt.</p>
            <p className="text-white/70">Detta avtal är specifikt för <strong>köpmodellen</strong>, där Kunden äger produkten/systemet efter full betalning.</p>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">3. Tjänstebeskrivning</h2>
            <p className="text-white/70 mb-3">Hiems Handelsbolag åtar sig att leverera följande:</p>
            <div className="space-y-3 text-white/70">
              <div>
                <p className="font-semibold text-white">Tjänstens namn:</p>
                <p>________________________________</p>
              </div>
              <div>
                <p className="font-semibold text-white">Kort beskrivning:</p>
                <p>________________________________</p>
              </div>
              <div>
                <p className="font-semibold text-white">Specifika leverabler / omfattning:</p>
                <p>________________________________</p>
              </div>
            </div>
            ...
            <div className="mt-4 space-y-3">
              <div>
                <p className="font-semibold text-white mb-2">Teknisk struktur & integration:</p>
                <ul className="list-disc list-inside space-y-2 text-white/70 ml-4">
                  <li>AI-agenter via [VAPI / Retell / annan plattform]: __________________</li>
                  <li>Automatisering via [N8N / Make.com]: __________________</li>
                  <li>"Hjärna" via OpenRouter med modeller: [GPT / Claude / Gemini / Lovable Cloud]: ______</li>
                  <li>Serverlösning: [Hiems servrar / Kundens egna servrar]</li>
                  <li>CRM-integration: [Kundens CRM / Hiems dashboard / annan lösning]</li>
                  <li>Eventuell integrationskostnad: [FYLL I]</li>
                </ul>
              </div>

              <div>
                <p className="font-semibold text-white mb-2">Webb, dashboards & analys:</p>
                <ul className="list-disc list-inside space-y-2 text-white/70 ml-4">
                  <li>Inbyggt CRM: [Ja / Nej]</li>
                  <li>ROI-dashboard: [Ja / Nej]</li>
                  <li>Skalningssystem: [Ja / Nej]</li>
                  <li>Plattform: [Lovable Cloud / Annan]: __________________</li>
                </ul>
              </div>
            </div>
            <p className="text-white/70 mt-3 italic">Detta avsnitt kan anpassas fritt beroende på kundens specifika lösning.</p>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">4. Provperiod och betalning</h2>
            <p className="text-white/70 mb-3">Kunden beviljas en kostnadsfri provperiod om <strong>30 dagar</strong> ("Provperioden") från aktiveringsdatum: ____ / ____ / 20__.</p>
            
            <div className="space-y-4">
              <div>
                <p className="font-semibold text-white mb-2">4.1 Betalning vid köp</p>
                <ul className="list-disc list-inside space-y-2 text-white/70">
                  <li>50 % i förskott vid beställning, med garanti från Hiems för leverans enligt överenskommelse.</li>
                  <li>50 % efter leverans när produkten/systemet är godkänt av kunden.</li>
                  <li>Engångsavgift: __________ SEK (inkl. moms)</li>
                </ul>
              </div>

              <div>
                <p className="font-semibold text-white mb-2">4.2 Valfri support (månatlig avgift)</p>
                <ul className="list-disc list-inside space-y-2 text-white/70">
                  <li>Om Kunden önskar löpande support kan en månatlig supportavgift tecknas: __________ SEK/månad (inkl. moms).</li>
                  <li>Support omfattar felsökning, optimering och tillgång till framtida förbättringar enligt SLA.</li>
                </ul>
              </div>
            </div>
          </article>
          ...
          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">5. Drift och driftkostnader</h2>
            <p className="text-white/70 mb-3">När Kunden äger produkten ansvarar Kunden själv för driftkostnader och drift av AI-tjänsterna, inklusive tokenbaserade AI-tjänster (röst, chatt, etc.).</p>
            <ul className="list-disc list-inside space-y-2 text-white/70 mb-3">
              <li><strong>Enkel förklaring:</strong> Tokenbaserad AI innebär att användning genererar förbrukning av tokens som kan medföra kostnad beroende på användning.</li>
              <li>Kundens ansvar omfattar: infrastruktur, API-konton, molntjänster, tokenbudget och licenser.</li>
              <li>Specifik uppskattning av driftkostnader: [FYLL I]</li>
            </ul>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">6. Anpassningar och tillägg</h2>
            <p className="text-white/70 mb-3">Eventuella kundspecifika anpassningar eller extrafunktioner dokumenteras här:</p>
            <div className="space-y-2 text-white/70">
              <p>Beskrivning: __________________________________________</p>
              <p>Estimerad leveranstid: _________________________________</p>
              <p>Eventuell tilläggskostnad: _______________________________</p>
            </div>
            <p className="text-white/70 mt-3">Hiems ansvarar för implementering och testning enligt god branschpraxis.</p>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">7. Hänvisning till kompletterande dokument</h2>
            <p className="text-white/70 mb-3">Genom undertecknande bekräftar Kunden att ha tagit del av, förstått och godkänt följande dokument:</p>
            <ul className="list-disc list-inside space-y-2 text-white/70 mb-3">
              <li>HAV 1.0 – Hiems Allmänt Avtal</li>
            ...
            <p className="text-white/70">Alla dokument finns alltid tillgängliga på <a href="https://hiems.se" className="text-accent hover:underline">https://hiems.se</a>, längst ner på startsidan, och utgör en integrerad del av detta avtal. Genom att skriva under detta avtal godkänner Kunden dessa dokument med samma juridiska kraft som om de undertecknats separat.</p>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">8. Ägande och support</h2>
            <ul className="list-disc list-inside space-y-2 text-white/70">
              <li>Kunden äger systemet efter full betalning.</li>
              <li>Löpande support och uppdateringar ingår inte, utom om månatlig support tecknats enligt punkt 4.2.</li>
              <li>Eventuell ytterligare support kan beställas som separata konsulttjänster enligt offert.</li>
            </ul>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">9. Avtalstid och uppsägning</h2>
            <p className="text-white/70 mb-3">Tilläggsavtalet gäller från underteckningsdatumet och tills vidare. Uppsägning ska ske skriftligen minst 30 dagar före nästa faktureringsperiod.</p>
            <p className="text-white/70">Vid utebliven betalning eller allvarligt avtalsbrott gäller bestämmelserna i HAV 1.0 §7.</p>
          </article>

          <article className="mb-6">
            <h2 className="text-2xl font-semibold text-white mb-3">10. Tillämplig lag och tvister</h2>
            <p className="text-white/70 mb-3">Svensk lag tillämpas.</p>
            <p className="text-white/70">Tvister som inte kan lösas genom dialog avgörs av Stockholms tingsrätt som första instans.</p>
          </article>

          <article>
            <h2 className="text-2xl font-semibold text-white mb-3">11. Underskrifter</h2>
            <p className="text-white/70 mb-3">Detta Tilläggsavtal har upprättats i två exemplar, varav parterna tagit varsitt. Elektronisk signering accepteras och anses lika giltig som fysisk underskrift.</p>
            
            <div className="grid md:grid-cols-2 gap-6 mt-4">
              <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                <p className="font-semibold text-white mb-3">För Hiems Handelsbolag</p>
                <div className="space-y-2 text-white/70">
                  <p>Namn: ________________________</p>
                  <p>Titel: ________________________</p>
                  <p>Datum: _______________________</p>
                  <p>Underskrift: _________________</p>
                </div>
              </div>

              <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                <p className="font-semibold text-white mb-3">För Kunden</p>
                <div className="space-y-2 text-white/70">
                  <p>Namn: ________________________</p>
                  <p>Titel: ________________________</p>
                  <p>Datum: _______________________</p>
