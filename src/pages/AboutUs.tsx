...
const teamMembers: TeamMember[] = [{
  ...
  highlights: ["Strategisk riktning och hands-on utveckling av skräddarsydda AI-lösningar", "Både förstår affären och kan bygga lösningen tekniskt", "Hjälper företag över alla branscher att implementera AI på riktigt", "Ingen copy-paste. Ingen one-size-fits-all. Alltid ordentlig behovsanalys först", "Bygger system som faktiskt löser specifika utmaningar och ökar lönsamhet", "Driven, passionerad och slutför det jag påbörjar. Period.", "Bakgrund från Södra Latins naturvetenskapsprogram", "Nyfikenhet och vilja att lösa problem driver mig framåt varje dag"]
}, {
  name: "Anton Sallnäs",
  role: "CEO",
  image: antonImage,
  ...
  highlights: ["Grundare och VD - driver Hiems strategiska vision", "Såg tidigt den enorma potentialen i AI för företag", "Bakgrund från Södra Latins naturvetenskapsprogram", "Expert på att identifiera affärsmöjligheter med AI-teknik", "Bygger långsiktiga partnerskap med våra kunder", "Fokus på att göra komplex teknologi enkel att använda", "Strategisk affärsutveckling och ledarskap"]
}, {
  ...
  highlights: ["Chief Legal Officer - ansvarar för legal och compliance", "Bakgrund från Bernadotte Gymnasiet", "Militär utbildning gav stark grund i ledarskap och organisation", "Expert inom dokumentation och pappersarbete", "Säkerställer att alla våra AI-lösningar följer regelverk och best practices", "Strukturerad approach till komplexa utmaningar", "Bygger robusta processer och system"]
}, {
  name: "Malte Ekbäck",
  role: "CFO",
  ...
  highlights: ["Chief Financial Officer - driver företagets ekonomiska strategi", "Entreprenör sedan tidig ålder med försäljningserfarenhet", "Kreativ problemlösare som ser möjligheter överallt", "Har byggt upp affärsförståelse genom praktisk erfarenhet", "Driven av att maximera värdeskapande för kunder och företag", "Kombinerar finansiell expertis med entreprenöriellt tänkande", "Fokus på hållbar tillväxt och lönsamhet"]
}];
const industries = ["VVS-firmor", "Advokatbyråer", "Byggföretag", "Naprapater", "Skönhetskliniker", "Bilverkstäder", "Frisörsalonger", "Industrier", "Städfirmor", "Takläggare", "Revisionsbyråer", "Redovisningsbyråer", "Konsultfirmor", "Tandläkare", "Fysioterapeuter", "Arkitektkontor", "Läkarmottagningar", "Kiropraktorer", "E-handelsföretag", "Restauranger"];
const AboutUs = () => {
  ...
  return <div className="relative overflow-hidden min-h-screen bg-gradient-hero">
      <Header1 />
      ...
      <AuroraBackground>
        <main className="relative">
                ...
                <div className="mx-auto max-w-4xl text-center space-y-8">
                  ...
                  <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight">
                    ...
                    <span className="relative flex justify-center overflow-hidden min-h-[1.2em]">
                      {industries.map((industry, index) => <motion.span key={index} className="absolute font-extrabold bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent" initial={{
                      opacity: 0,
                      y: -100
                    }} transition={{
                      type: "spring",
                  ...
                  <Card className="bg-card/20 backdrop-blur-md border border-primary/10">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 pt-4">
                      {[{
                        ...
                        desc: "Som förstår svenska marknaden och företag"
                      }, {
                        title: "Teknisk expertis + Affärsförståelse",
                        desc: "Vi både förstår och bygger lösningen"
                      }, {
                        title: "End-to-End",
                        desc: "Från strategi till implementation - allt under ett tak"
                      }, {
                        title: "Bevisat ROI",
                        desc: "Våra kunder ser mätbar avkastning"
                      }].map(item => <div key={item.title} className="flex items-start gap-3 group">
          ...
          <section className="relative py-24 md:py-32 overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[{
                title: "Transparens",
                desc: "Inga dolda kostnader eller fluffiga löften. Vi är alltid ärliga om vad som är möjligt och vad det kostar."
              }, {
                title: "Expertis",
                desc: "Djup teknisk kunskap från AI-modeller till implementation. Vi vet vad vi gör."
              }, {
                title: "Resultat",
                desc: "Vi mäts på er framgång, inte våra timmar. Mätbara resultat är vår målsättning."
              }, {
                title: "Partnerskap",
                desc: "Vi är er långsiktiga AI-partner, inte bara en leverantör. Vi växer tillsammans."
              }].map((value, index) => <AnimatedSection key={value.title} delay={index * 100}>
                    <Card className="h-full bg-card/20 backdrop-blur-md border border-primary/10">
          ...
          <section className="relative py-12 md:py-16 overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {[{
                title: "Lyssna",
                desc: "Vi börjar alltid med att förstå era specifika utmaningar och mål.",
                icon: Users
              }, {
                title: "Analysera",
                desc: "Djup behovsanalys innan vi föreslår någon lösning.",
                icon: Lightbulb
              }, {
                title: "Bygga",
                desc: "Skräddarsydda AI-system som löser era verkliga problem.",
                icon: Rocket
              }, {
                title: "Optimera",
                desc: "Kontinuerlig förbättring baserat på data och resultat.",
                icon: TrendingUp
              }].map((step, index) => <AnimatedSection key={step.title} delay={index * 100}>
                    <div className="text-center space-y-4">
          ...
          <section id="team-section">
            <TeamSection title="TEAM" description="Människorna som gör AI-magin möjlig" members={teamMembers.map(member => ({
            name: member.name,
                ...
                <Card className="bg-card/20 backdrop-blur-md border border-primary/10">
                  ...
                  <div className="space-y-8">
                    {[{
                      year: "2024",
                      title: "Hiems Grundas",
                      desc: "Hiems grundas med fokus på AI-lösningar för att revolutionera svensk affärsverksamhet genom innovativ teknologi."
                    }, {
                      year: "2025",
                      title: "ChronoDesk Grundas",
                      desc: "ChronoDesk startas med specialisering inom AI-driven automation och intelligenta system."
                    }, {
                      year: "Okt 2025",
                      title: "Historisk Sammanslagning",
                      desc: "Hiems och ChronoDesk slår sina krafter samman och etablerar samtidigt sitt första strategiska partnerskap med en klient."
                    }, {
                      year: "2025-",
                      title: "Explosiv Tillväxt",
                      desc: "Ett otroligt snabbt växande företag med fler kunder, fler branscher och fler framgångshistorier varje månad."
                    }].map((milestone, index) => <AnimatedSection key={milestone.year} delay={index * 100}>
                        ...
                        {index < 3 && <div className="ml-10 w-0.5 h-8 bg-gradient-to-b from-primary/50 to-primary/20" />}
                      </AnimatedSection>)}
                  </div>
                  </CardContent>
                </Card>
          ...
          <section className="relative py-12 md:py-16 overflow-hidden">
            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                desc: "Vi förstår svenska företag, svenska marknaden och svenska utmaningar. Ingen kulturell eller språklig barriär.",
                image: svensktLokalImage
              }, {
                title: "End-to-End",
                desc: "Från strategi till drift, vi hanterar allt. En partner för hela er AI-resa, inte bara en leverantör.",
                image: endToEndImage
              }, {
                title: "Bevisat ROI",
                desc: "Våra kunder ser mätbar avkastning. Vi bygger system som faktiskt ökar lönsamhet och effektivitet.",
                image: bvisatRoiImage
              }].map((benefit, index) => <AnimatedSection key={benefit.title} delay={index * 100}>
