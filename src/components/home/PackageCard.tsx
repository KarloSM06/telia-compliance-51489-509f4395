...
export const PackageCard = ({
  ...
  return (
    <Card className="h-[500px] flex flex-col lg:flex-row hover:shadow-2xl transition-all duration-500 border hover:border-primary/40 overflow-hidden bg-gradient-to-br from-card/95 to-card backdrop-blur-sm">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 p-8 lg:p-10">
          <div className="lg:col-span-1 space-y-4">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 bg-gradient-to-br from-primary/15 to-primary/5 rounded-xl ring-1 ring-primary/10">
          ...
          <div className="lg:col-span-1 space-y-3">
            ...
            <div className="space-y-2.5">
              {pkg.components.map((component, index) => (
                <div key={index} className="flex items-start gap-2.5 p-2 rounded-lg hover:bg-primary/5 transition-colors group">
          ...
          <div className="lg:col-span-1 flex flex-col justify-between space-y-4">
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                {pkg.valueBullets.map((bullet, index) => (
                  <div key={index} className="flex items-start gap-2.5 p-2 rounded-lg hover:bg-accent/5 transition-colors group">
            ...
            <Button 
              size="lg" 
              className="w-full shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 bg-gradient-to-r from-primary via-primary to-accent hover:from-primary/90 hover:via-primary/90 hover:to-accent/90 font-semibold" 
              onClick={onBookDemo}
            >
