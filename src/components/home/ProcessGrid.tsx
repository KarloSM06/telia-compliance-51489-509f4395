          ...
          {processSteps.map((step, index) => (
            <AnimatedSection key={step.id} delay={index * 100}>
              <div className="border-2 border-white/10 bg-white/5 backdrop-blur-sm rounded-3xl p-10 md:p-12 shadow-lg hover:shadow-xl transition-all">
                ...
                {/* Visual Mockup Area */}
                {step.id === 3 ? (
                  <div className="bg-white/40 backdrop-blur-sm border border-gray-200 rounded-xl p-0 flex items-center justify-center overflow-hidden -mt-12 h-auto">
                    <div className="w-full flex justify-center -my-20 -mb-24">
                      <DatabaseWithRestApi 
