        ...
        <AnimatedSection delay={200}>
            <div className="grid md:grid-cols-2 gap-12">
              <div className="border border-gray-100 bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-full h-40 bg-gradient-to-br from-indigo-500/12 via-purple-400/6 to-transparent pointer-events-none" />
              ...
              <div className="border border-gray-100 bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden">
                ...
                <div className="absolute top-0 right-0 w-full h-40 bg-gradient-to-bl from-purple-500/12 via-indigo-400/6 to-transparent pointer-events-none" />
