  ...
  return <AnimatedContainer delay={delay}>
    <Card className="relative overflow-hidden">
      <CardContent className="py-4 px-4">
        <div className="relative flex aspect-square size-10 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
...
export const ServiceDataFlow = () => {
  return <section className="bg-background/50 py-12 md:py-20">
    <div className="mx-auto max-w-7xl px-4 md:px-6">
      <AnimatedContainer className="mx-auto max-w-3xl text-center mb-8">
        <h2 className="text-2xl font-bold tracking-wide text-balance md:text-3xl lg:text-4xl mb-3">
          <span className="bg-gradient-to-r from-primary via-primary/80 to-primary/60 bg-clip-text text-transparent">
            Så Flödar Data Genom Våra Tjänster
          </span>
        </h2>
        <p className="text-muted-foreground text-sm tracking-wide text-balance">
      ...
      <div className="relative">
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card className="relative flex overflow-hidden">
            <CardContent className="relative m-auto size-fit py-4 px-4">
              <div className="relative flex h-16 w-36 items-center">
                ...
                <span className="mx-auto block w-fit text-3xl font-semibold">AI</span>
              </div>
              <h2 className="mt-3 text-center text-xl font-semibold">Intelligent</h2>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden">
            <CardContent className="py-4 px-4">
              <div className="relative flex aspect-square size-10 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                <Brain className="m-auto size-5 text-primary" strokeWidth={1.5} />
              </div>
              <div className="relative z-10 mt-4 space-y-1.5">
                <h2 className="text-base font-semibold text-foreground">AI Modeller (LLM)</h2>
                <p className="text-xs text-muted-foreground">Processar data med avancerade språkmodeller för intelligent output.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden">
            <CardContent className="py-4 px-4">
              <div className="relative flex aspect-square size-10 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                <Workflow className="m-auto size-5 text-primary" strokeWidth={1.5} />
              </div>
              <div className="relative z-10 mt-4 space-y-1.5">
                <h2 className="text-base font-semibold text-foreground">Automation & Integration</h2>
                <p className="text-xs text-muted-foreground">Synkar data mellan system och kör automatiska workflows vid triggers.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden sm:col-span-2">
            <CardContent className="grid py-4 px-4 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-4">
                <div className="relative flex aspect-square size-10 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <BarChart3 className="m-auto size-5 text-primary" strokeWidth={1.5} />
                </div>
                <div className="space-y-1.5">
                  <h2 className="text-base font-semibold text-foreground">CRM & Analytics</h2>
                  <p className="text-xs text-muted-foreground">Analyserar mönster från alla kanaler i realtid.</p>
                </div>
              </div>
              <div className="rounded-tl relative -mb-4 -mr-4 mt-4 h-fit border-l border-t p-4 py-4 sm:ml-4">
                <div className="absolute left-2 top-1.5 flex gap-1">
                  <span className="block size-1.5 rounded-full border dark:border-white/10 dark:bg-white/10"></span>
                  <span className="block size-1.5 rounded-full border dark:border-white/10 dark:bg-white/10"></span>
                  <span className="block size-1.5 rounded-full border dark:border-white/10 dark:bg-white/10"></span>
                </div>
          ...
          {/* Offert & Faktura */}
          <Card className="relative overflow-hidden sm:col-span-2">
            <CardContent className="grid h-full py-4 px-4 sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-4">
                <div className="relative flex aspect-square size-10 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <FileText className="m-auto size-5 text-primary" strokeWidth={1.5} />
                </div>
                <div className="space-y-1.5">
                  <h2 className="text-base font-semibold text-foreground">Offert & Faktura AI</h2>
                  <p className="text-xs text-muted-foreground">Genererar offerter automatiskt med AI-precision.</p>
                </div>
              </div>
              <div className="relative mt-4 flex items-center justify-center before:absolute before:inset-0 before:mx-auto before:w-px before:bg-border sm:-my-4 sm:-mr-4">
                <div className="relative flex flex-col space-y-3 py-4">
