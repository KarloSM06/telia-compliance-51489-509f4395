    ...
    <div className="mx-auto max-w-7xl px-6 md:px-8">
      ...
      <div className="relative">
        <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="relative flex overflow-hidden sm:col-span-2 bg-gradient-to-br from-primary/5 to-primary/10">
            <CardContent className="relative flex items-center gap-6 py-6 px-6 w-full">
              <div className="relative flex h-20 w-40 items-center shrink-0">
                <svg className="text-primary/60 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="mx-auto block w-fit text-4xl font-semibold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">AI</span>
              </div>
