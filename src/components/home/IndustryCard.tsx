...
export const IndustryCard = memo(({
  ...
  return <Card 
      className="industry-card-wrapper group h-full flex flex-col overflow-hidden cursor-pointer border border-primary/10 bg-gradient-to-br from-card/80 via-card/50 to-card/30 hover:bg-card/90 hover:border-primary/30 transition-[transform,opacity,box-shadow,border-color] duration-300 hover:shadow-2xl hover:shadow-primary/20" 
      onClick={onClick}
