...
export const IndustryCard = ({
  ...
  return <Card className="group h-full flex flex-col overflow-hidden cursor-pointer border-border/50 bg-card/80 hover:bg-card hover:border-primary/40 transition-[transform,border-color] duration-300 hover:shadow-lg hover:-translate-y-1 transform-gpu" onClick={onClick}>
      ...
      <div className="relative aspect-[4/3] overflow-hidden bg-muted">
        {industry.image ? <img src={industry.image} alt={industry.name} decoding="async" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105 transform-gpu" /> : <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-primary/10 to-muted flex items-center justify-center">
