  ...
  return <Card className="group h-full flex flex-col overflow-hidden cursor-pointer border border-primary/10 bg-gradient-to-br from-card/80 via-card/50 to-card/30 backdrop-blur-md hover:bg-card/90 hover:border-primary/30 transition-[transform,colors,box-shadow,border-color,opacity,filter] duration-500 transform-gpu [will-change:transform,filter] hover:shadow-2xl hover:shadow-primary/20 hover:-translate-y-2" onClick={onClick}>
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {industry.image ? <>
            ...
            <img src={industry.image} alt={industry.name} decoding="async" loading="lazy" fetchPriority="low" className="w-full h-full object-cover transform-gpu [will-change:transform,filter] transition-transform duration-700 group-hover:scale-110 group-hover:brightness-110" />
