...
const AnimatedHeader = () => {
  ...
  return (
    <div className="text-center max-w-6xl mx-auto mb-24">
      ...
      <p 
        ref={pRef}
        className={`text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mt-8 transition-all duration-700 ease-out delay-200 ${pInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        style={{ transformStyle: 'preserve-3d' }}
      >
...
export function StickyPackageCards({ packages, onBookDemo, onViewDetails }: StickyPackageCardsProps) {
  return (
    <AuroraBackground className="h-auto">
      <section id="paket" className="relative py-32 md:py-64">
        <div className="px-[5%]">
