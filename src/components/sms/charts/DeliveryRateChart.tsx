  ...
  if (!data || data.length === 0) {
    return (
      <Card className="p-6 border-2 border-white/10 bg-white/5 backdrop-blur-sm hover:border-white/20 hover:bg-white/10 transition-all duration-300">
        <h3 className="text-sm font-medium mb-4 text-primary">Leveransgrad</h3>
  ...
  return (
    <Card className="p-6 border-2 border-white/10 bg-white/5 backdrop-blur-sm hover:border-white/20 hover:bg-white/10 transition-all duration-300">
      <div className="flex justify-between items-start mb-4">
        <h3 className="text-sm font-medium text-primary">Leveransgrad</h3>
        <div className="text-right">
          <div className="text-2xl font-bold text-green-600">{avgDeliveryRate.toFixed(1)}%</div>
          <div className="text-xs text-primary/80">Genomsnitt</div>
        </div>
      </div>
