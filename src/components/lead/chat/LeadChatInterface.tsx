...
export const LeadChatInterface = () => {
  ...
  return (
    <div className="h-full flex gap-4">
      ...
      <Sheet open={showSidebar} onOpenChange={setShowSidebar}>
        <SheetTrigger asChild>
          <Button
            variant="ghost"
            size="icon"
            className="lg:hidden fixed top-4 left-4 z-50 text-white bg-gradient-to-r from-stone-600 to-amber-700 hover:from-stone-700 hover:to-amber-800"
          >
      ...
      {/* Chat Area */}
      <Card className="flex-1 flex flex-col bg-gradient-to-br from-stone-50/50 to-amber-50/50 dark:from-stone-950/20 dark:to-amber-950/20">
        <CardHeader className="border-b bg-gradient-to-r from-stone-600 to-amber-700 text-white">
              ...
              {messages.map((message) => (
                ...
                >
                  {message.role === 'assistant' && (
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-stone-600 to-amber-700 flex items-center justify-center flex-shrink-0">
        ...
        <div className="p-4 border-t bg-background">
          <div className="flex gap-2">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-stone-600 to-amber-700 hover:from-stone-700 hover:to-amber-800"
            >
