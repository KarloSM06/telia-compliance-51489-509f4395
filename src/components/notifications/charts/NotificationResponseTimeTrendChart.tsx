...
interface NotificationResponseTimeTrendChartProps {
  data: any[];
  isLoading?: boolean;
}

export function NotificationResponseTimeTrendChart({ data, isLoading }: NotificationResponseTimeTrendChartProps) {
  if (isLoading) {
    return (
    ...
    return (
      <Card className="p-6 border border-primary/10 bg-gradient-to-br from-card/80 via-card/50 to-card/30 backdrop-blur-md">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="font-semibold">Läsningstid</h3>
        </div>
