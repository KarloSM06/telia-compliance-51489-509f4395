...
function LogoCard({
  ...
  return <div className={cn("group relative flex items-center justify-center bg-white px-8 py-16 md:p-16 overflow-hidden", className)} {...props}>
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-purple-600/40 to-transparent" />
        <div className="absolute right-0 top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-purple-600/40 to-transparent" />
      </div>
      <img alt={logo.alt} className="pointer-events-none select-none object-contain w-full transition-all duration-300 group-hover:scale-110" style={{
