    ...
    <header className="w-full z-40 fixed top-0 left-0 transition-all duration-500">
        <div className="container relative mx-auto min-h-20 flex gap-4 flex-row lg:grid lg:grid-cols-3 items-center">
          <div className="justify-start items-center gap-2 lg:flex hidden flex-row">
            {navigationItems.map(item => item.href ? <Link key={item.title} to={item.href}>
          ...
          <div className="flex justify-end w-full gap-4">
            ...
            {user ? <DropdownMenu>
              ...
              </DropdownMenu> : <Button variant="outline" size="sm" onClick={handleAuthClick} className="hidden md:inline rounded-xl hover:bg-gradient-gold hover:text-primary hover:border-primary/20 transition-all duration-300 hover:scale-105 font-medium">
                Logga in
              </Button>}
          ...
          <div className="flex w-12 shrink lg:hidden items-end justify-end">
            ...
            {isOpen && <div className="absolute top-20 border-t flex flex-col w-full right-0 bg-background/95 backdrop-blur-2xl shadow-lg py-4 container gap-8 animate-fade-in">
