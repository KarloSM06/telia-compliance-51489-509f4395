...
export const ProjectManagementVisual: React.FC<ProjectManagementVisualProps> = ({
  ...
  return (
    <div className={`h-[500px] w-full max-w-[900px] mx-auto bg-white/80 backdrop-blur-xl border border-gray-100 rounded-2xl shadow-lg p-10 ${className}`}>
      <div className="space-y-8">
        ...
        >
          <h3 className="text-2xl font-display font-normal text-gray-900">New Details</h3>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white/60 backdrop-blur-sm border border-gray-200 rounded-xl p-4 hover:bg-white/80 hover:shadow-md transition-all duration-300"
        >
          ...
          <input
            ...
            className="w-full bg-transparent text-gray-900 placeholder:text-gray-400 outline-none text-base font-medium"
            disabled
          />
        </motion.div>
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-start gap-4">
              ...
              <motion.div
                ...
                className="w-6 h-6 bg-gradient-to-br from-indigo-500 via-purple-500 to-purple-600 rounded flex items-center justify-center flex-shrink-0 mt-0.5"
              >
                <Check className="w-4 h-4 text-white" strokeWidth={2.5} />
              </motion.div>
              
              <div>
                <h4 className="text-base font-semibold text-gray-900 mb-1">Ongoing project</h4>
            ...
            <Info className="size-5 text-foreground/75 flex-shrink-0" strokeWidth={1} aria-hidden />
          </div>
        </motion.div>
          ...
          <div className="relative">
            ...
            <div className="relative h-1 bg-gray-200 rounded-full">
              ...
              {dates.map((_, idx) => (
                <motion.div
                  key={idx}
                  className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-gradient-to-br from-indigo-500 to-purple-600 border-2 border-white rounded-full shadow-md"
                  style={{
        ...
        <motion.div
          ...
          className="bg-white/90 backdrop-blur-md border border-gray-200 rounded-xl p-6 hover:bg-white/95 hover:shadow-md transition-all duration-300"
        >
          <h4 className="text-base font-semibold text-gray-900 mb-6">Resource load</h4>
