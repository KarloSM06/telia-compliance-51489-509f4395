...
// Shader material for light blue animated background
const vertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
const fragmentShader = `
  ...
  vec4 cppn_fn(vec2 coordinate, float in0, float in1, float in2) {
    ...
    * buf[7]
    ...
    // Convert to light blue color scheme
    vec3 baseColor = vec3(0.4, 0.7, 1.0); // Light blue
    vec3 color = mix(baseColor * 0.3, baseColor * 1.2, buf[0].xyz);
