  ...
  return (
    <div className="relative h-full w-full flex flex-col justify-center gap-3 md:gap-4 lg:gap-6 px-4 md:px-6 lg:px-8 bg-white/50 backdrop-blur-md border border-gray-300 rounded-xl shadow-lg">
      {systems.map((system, index) => (
        <div
          key={system.label}
          className="flex items-center justify-between p-3 md:p-4 lg:p-6 min-h-[60px] md:min-h-[70px] bg-white/80 backdrop-blur-xl border border-gray-300 rounded-lg shadow-md transition-all duration-300 hover:scale-[1.03] hover:shadow-xl hover:rotate-[0.5deg] animate-fade-in-left animate-float"
          style={{
        ...
        >
          ...
          <div className="flex-shrink-0">
              ...
              <div className="relative w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16" style={{ filter: "drop-shadow(0 0 8px rgba(99, 102, 241, 0.3))" }}>
                ...
                <svg className="w-full h-full transform -rotate-90" viewBox="0 0 64 64">
                  ...
                  <circle
                    ...
                    fill="none"
                    strokeLinecap="round"
                    className="text-indigo-600 animate-progress"
                    style={{
            ...
            {system.indicator === "arrow" && (
              <div
                className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full bg-orange-500/20 border-2 border-orange-500 flex items-center justify-center animate-bounce-slow"
            ...
            {system.indicator === "check" && (
              <div
                className="w-10 h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 rounded-full bg-green-500/20 border-2 border-green-500 flex items-center justify-center animate-scale-in"
                style={{ 
