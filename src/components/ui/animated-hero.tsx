...
function AnimatedHero({
  ...
  return (
    <div className="w-full min-h-screen relative overflow-hidden">
      ...
      {/* Content Overlay */}
      <div className="container mx-auto max-w-5xl px-6 relative z-20 min-h-screen flex items-center">
        <div className="flex gap-8 items-center justify-center flex-col w-full py-32">
          <div className="flex gap-6 flex-col items-center">
            ...
            <AnimatedSection delay={100}>
              <motion.p 
                ...
                className="text-base md:text-lg leading-relaxed text-muted-foreground max-w-2xl text-center font-normal mt-2 backdrop-blur-md bg-background/40 p-4 rounded-xl drop-shadow-lg"
              >
          ...
          <AnimatedSection delay={200}>
            ...
            >
              <Button 
                variant="outline" 
                className="group hover:bg-gradient-gold hover:text-primary hover:border-primary/20 transition-all duration-300 font-bold rounded-xl hover:scale-105 backdrop-blur-md bg-background/60"
