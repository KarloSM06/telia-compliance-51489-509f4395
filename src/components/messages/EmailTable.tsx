...
import { Eye, CheckCircle, XCircle, Clock, Mail as MailIcon } from "lucide-react";
...
export const EmailTable = ({ messages, onViewDetails }: EmailTableProps) => {
  if (messages.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        <p>Inga email-meddelanden att visa</p>
      </div>
    );
  }
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Öppnat</TableHead>
            <TableHead>Klickat</TableHead>
