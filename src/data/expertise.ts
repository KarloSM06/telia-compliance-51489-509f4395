...
import outlookNewLogo from "@/assets/integrations/outlook-new.png";
import calendlyNewLogo from "@/assets/integrations/calendly-new.png";
...
export const expertiseCategories: ExpertiseCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Microsoft Outlook", type: "service", description: "Enterprise kalender", logo: outlookNewLogo },
      { name: "Calendly", type: "service", description: "Bokningssystem", logo: calendlyNewLogo },
